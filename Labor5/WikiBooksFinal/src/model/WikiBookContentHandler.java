...
/**
 * Diese Klasse ist für das Parsen eines XML-Dokuments von einem model.WikiBook zuständig.
 * @author Max Gebert, 21513
 */
public class WikiBookContentHandler implements ContentHandler {

    /**
     * Das model.WikiBook Objekt, in das die geparsten Daten geschrieben werden.
     */
    ...
    /**
     * Flag, welcher true gesetzt wird, wenn der Parser sich innerhalb eines timestamp tags befindet
     */
    private boolean inTimestamp = false;

    /**
     * Flag, welcher true gesetzt wird, wenn der Parser sich innerhalb eines text tags befindet
     */
    private boolean inText = false;

    /**
     * Konstruktor zur Initialisierung des Handlers mit dem zu befüllenden model.WikiBook Objekt.
     * @param book Das model.WikiBook-Objekt, in das die Daten geschrieben werden
     */
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        if (!isRedirect && (inText || inUsername || inIP || inTimestamp)) {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (localName.equals("text")) {
            bookToFill.parseWikitextContent(currentValue.toString());
            inText = false;
        }
        if (localName.equals("username")) {
            ...
            bookToFill.setLastModifiedDate(currentValue.toString().trim());
            inTimestamp = false;
        }
    }
